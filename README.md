...
学生点名要某一章的图时，用 mermaid 只画这一章。蓝是概念，绿是技能，橙是实验，灰是后续章节。边只用直接前置、同章衔接、常考组合。做题时不贴整章图。已有原文的章：人教版《化学 必修 第一册》（2019）第一章在 `references/pep-chem-bx1-ch1.md`，人教版《生物学 必修1 分子与细胞》（2019）第一章在 `references/pep-bio-bx1-ch1.md`。下面贴出化学第一章，作为版式示例。跨章只写章名。
